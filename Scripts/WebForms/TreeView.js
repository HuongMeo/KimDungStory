...
function TreeView_ProcessNodeData(result, context) {
    ...
    if (result.length > 0) {
        ...
        if ((typeof(img) != "undefined") && (img != null)) {
            ...
            if (lineType == "l") {
                img.src = context.data.Temp/images[13];
            }
            else if (lineType == "t") {
                img.src = context.data.Temp/images[10];
            }
            else if (lineType == "-") {
                img.src = context.data.Temp/images[16];
            }
            else {
                img.src = context.data.Temp/images[3];
            }
            var pe;
            if (__nonMSDOMBrowser) {
...
function TreeView_ToggleNode(data, index, node, lineType, children) {
    ...
    try {
        if (children.style.display == "none") {
            ...
            if ((typeof(img) != "undefined") && (img != null)) {
                if (lineType == "l") {
                    img.src = data.Temp/images[15];
                }
                else if (lineType == "t") {
                    img.src = data.Temp/images[12];
                }
                else if (lineType == "-") {
                    img.src = data.Temp/images[18];
                }
                else {
                    img.src = data.Temp/images[5];
                }
            ...
            if ((typeof(img) != "undefined") && (img != null)) {
                if (lineType == "l") {
                    img.src = data.Temp/images[14];
                }
                else if (lineType == "t") {
                    img.src = data.Temp/images[11];
                }
                else if (lineType == "-") {
                    img.src = data.Temp/images[17];
                }
                else {
                    img.src = data.Temp/images[4];
                }
